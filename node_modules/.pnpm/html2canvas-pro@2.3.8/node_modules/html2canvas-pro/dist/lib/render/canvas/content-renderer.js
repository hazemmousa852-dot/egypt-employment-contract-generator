...
exports.wrapTextToWidth = void 0;
...
function renderFormElements(ctx, textRenderer, pathFn, container, styles) {
    ...
    if (isTextInputElement(container) && container.value.length) {
        ...
        ctx.font = font;
        const baseline = (0, font_utils_1.measureBaseline)(ctx, (0, length_percentage_1.getAbsoluteValue)(styles.fontSize, 0));
